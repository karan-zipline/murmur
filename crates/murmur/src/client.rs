...
pub async fn ping(paths: &MurmurPaths) -> anyhow::Result<PingResponse> {
    let req = Request {
...
pub async fn shutdown(paths: &MurmurPaths) -> anyhow::Result<()> {
    let req = Request {
...
pub async fn project_list(paths: &MurmurPaths) -> anyhow::Result<ProjectListResponse> {
    let req = Request {
...
pub async fn agent_list(paths: &MurmurPaths) -> anyhow::Result<AgentListResponse> {
    let req = Request {
...
pub async fn agent_abort(paths: &MurmurPaths, agent_id: String, force: bool) -> anyhow::Result<()> {
...
pub async fn agent_delete(paths: &MurmurPaths, agent_id: String) -> anyhow::Result<()> {
...
pub async fn agent_idle(paths: &MurmurPaths, agent_id: String) -> anyhow::Result<()> {
...
pub async fn orchestration_stop(paths: &MurmurPaths, project: String) -> anyhow::Result<()> {
...
pub async fn stats(paths: &MurmurPaths, project: Option<String>) -> anyhow::Result<StatsResponse> {
...
pub async fn issue_list(paths: &MurmurPaths, project: String) -> anyhow::Result<IssueListResponse> {
...
pub async fn issue_close(paths: &MurmurPaths, project: String, id: String) -> anyhow::Result<()> {
    let payload = murmur_protocol::IssueCloseRequest { project, id };
    let req = Request {
...
pub async fn issue_commit(paths: &MurmurPaths, project: String) -> anyhow::Result<()> {
...
pub async fn plan_stop(paths: &MurmurPaths, id: String) -> anyhow::Result<()> {
...
pub async fn plan_show(paths: &MurmurPaths, id: String) -> anyhow::Result<PlanShowResponse> {
...
pub async fn manager_start(paths: &MurmurPaths, project: String) -> anyhow::Result<()> {
...
pub async fn manager_stop(paths: &MurmurPaths, project: String) -> anyhow::Result<()> {
...
pub async fn manager_clear_history(paths: &MurmurPaths, project: String) -> anyhow::Result<()> {
