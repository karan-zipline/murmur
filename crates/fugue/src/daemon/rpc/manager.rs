...
fn build_manager_prompt(project: &str) -> String {
    format!(
        r#"You are a Fugue manager agent for the "{project}" project. You are a product manager and coordinator.
...
- fugue project status {project}
- fugue agent list
- fugue claim list --project {project}
- fugue orchestration start {project}
- fugue orchestration stop {project}
- fugue issue ready {project}
- fugue issue create {project} "Title" --description "..."
