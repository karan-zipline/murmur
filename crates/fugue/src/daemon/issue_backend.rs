use fugue_core::config::IssueBackend;
...
impl<'a> IssueBackendImpl<'a> {
    pub(in crate::daemon) async fn get(
        &self,
        id: &str,
    ) -> anyhow::Result<fugue_core::issue::Issue> {
        match self {
    ...
    pub(in crate::daemon) async fn list(
        &self,
        filter: fugue_core::issue::ListFilter,
    ) -> anyhow::Result<Vec<fugue_core::issue::Issue>> {
        match self {
    ...
    pub(in crate::daemon) async fn ready(&self) -> anyhow::Result<Vec<fugue_core::issue::Issue>> {
        match self {
    ...
    pub(in crate::daemon) async fn create(
        &self,
        now_ms: u64,
        params: fugue_core::issue::CreateParams,
    ) -> anyhow::Result<fugue_core::issue::Issue> {
        match self {
    ...
    pub(in crate::daemon) async fn update(
        ...
        now_ms: u64,
        id: &str,
        params: fugue_core::issue::UpdateParams,
    ) -> anyhow::Result<fugue_core::issue::Issue> {
        match self {
    ...
    pub(in crate::daemon) async fn plan(
        ...
        let description = fugue_core::issue::upsert_plan_section(&issue.description, plan_content);
        let _ = self
            .update(
                now_ms,
                id,
                fugue_core::issue::UpdateParams {
