...
use fugue_protocol::{AttachRequest, Request, Response, MSG_ATTACH};
...
impl DaemonTuiClient {
    pub fn new(paths: FuguePaths) -> Self {
        Self { paths }
    }
}
...
impl TuiClient for DaemonTuiClient {
    ...
    async fn project_list(&self) -> anyhow::Result<fugue_protocol::ProjectListResponse> {
        crate::client::project_list(&self.paths).await
    }

    async fn agent_list(&self) -> anyhow::Result<fugue_protocol::AgentListResponse> {
    ...
    async fn agent_chat_history(
        ...
        agent_id: String,
        limit: Option<u32>,
    ) -> anyhow::Result<fugue_protocol::AgentChatHistoryResponse> {
    ...
    async fn commit_list(
        ...
        limit: Option<u32>,
    ) -> anyhow::Result<fugue_protocol::CommitListResponse> {
    ...
    async fn stats(
        &self,
        project: Option<String>,
    ) -> anyhow::Result<fugue_protocol::StatsResponse> {
    ...
    async fn permission_list(
        &self,
        project: Option<String>,
    ) -> anyhow::Result<fugue_protocol::PermissionListResponse> {
    ...
    async fn permission_respond(
        &self,
        id: String,
        behavior: fugue_protocol::PermissionBehavior,
    ) -> anyhow::Result<()> {
    ...
    async fn question_list(
        &self,
        project: Option<String>,
    ) -> anyhow::Result<fugue_protocol::UserQuestionListResponse> {
    ...
    async fn question_respond(
        ...
        crate::client::question_respond(
            &self.paths,
            fugue_protocol::UserQuestionRespondPayload { id, answers },
        )
        .await
    }
    ...
    async fn plan_start(
        ...
        project: Option<String>,
        prompt: String,
    ) -> anyhow::Result<fugue_protocol::PlanStartResponse> {
